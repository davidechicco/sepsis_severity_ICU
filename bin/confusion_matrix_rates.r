...
list.of.packages <- c("PRROC", "e1071", "Metrics")
...
regression_rates <- function (actual_labels, predicted_values, keyword)
{
    ...
    cat("  @@@ SOFA score :: \t RMSE \t MAE \t MSE  \t SMAPE \n")
    cat("  @@@ SOFA score :: \t ", dec_two(thisRMSE), " \t ", dec_two(thisMAE), " \t ", dec_two(thisMSE),  " \t ", dec_two(thisSMAPE)," \n", sep="")
}
