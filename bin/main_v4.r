...
libraries("randomForest","caret","e1071","keras","ROSE","DMwR","Metrics","mltools","PRROC","MLmetrics","DescTools")
cat("\014")
set.seed(11)

# Parameters
method = "RF" #Options: TREE, RF, SVMLIN, SVMKER, MLP
nl = 300 # Size of the training set
mc = 100 # Number of repetition of the experiments
...
# Results
D <- read.csv('sepsis_severity_dataset_edited_2019-02-11.csv', header=TRUE);
if (method == "RF") {
...
cat("\014")
print(names(D)[iy[1]])
print(sprintf("method,mcc,f1,acc,rec,spec,prauc,rocauc"))
print(sprintf("%s & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ \\\\",
...
print(sprintf("method,mcc,f1,acc,rec,spec,prauc,rocauc"))
print(sprintf("%s & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ & $%.2f \\pm %.2f$ \\\\",
              method,ris3.m[1],ris3.s[1],ris3.m[2],ris3.s[2],ris3.m[3],ris3.s[3],ris3.m[4],ris3.s[4],ris3.m[5],ris3.s[5],ris3.m[6],ris3.s[6],ris3.m[7],ris3.s[7]))
if (method == "RF"){
  print(sprintf("Top %d Feature Set Method %d \\",topf,j))
  IM3 = IM3[1,,1]+IM3[1,,2]
