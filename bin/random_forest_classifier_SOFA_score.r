...
list.of.packages <- c("PRROC", "e1071", "randomForest","class", "gmodels", "formula.tools", "Metrics")
...
patients_data$"ADDED.survival" <- NULL
...
regression_rates(patients_data_test_labels, patients_data_test_PRED, "@@@ Test set @@@")
